...
public class LoginActivity extends AppCompatActivity {
    TextView register_now,tv_forgot_password,userNamec;
    Button login_btn;
...
public  void  initilize(){
        // greet user if first time signup + login
    String uname = sharedpreferences.getString(USER_KEY,"null");
    if (uname == "null"){
        userNamec.setText("Already Have an Account?");
    }else {
        userNamec.setText("Hey, "+uname+" Please Login to Continue 😄");
    }
